...
function RRouterCliProxy(){
  ...
  return a.jsx(re,{title:"9Router connection",children:a.jsxs("div",{className:"sand-provider-usage-card",style:{display:"grid",gap:10},children:[
    a.jsxs("label",{children:[a.jsx("strong",{children:"Base URL"}),a.jsx("input",{"aria-label":"9Router Base URL",className:RRouterInputClass,disabled:m,onChange:v=>{const y=v.currentTarget.value;if(q.current.trim()&&(z.current===null||RRouterOrigin(y)!==z.current))R();E.current=y;n(y)},spellCheck:!1,type:"url",value:t}),a.jsx("small",{children:"Authenticated /v1 root only. For this Tailscale server, use http://100.112.10.8:20128/v1. Never use /codex."})]}),
