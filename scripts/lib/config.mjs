...
export const cachedWindowsRuntimeRoot = path.join(cacheDir, "runtime", "windows-x64", "Grok Bot");
export const cachedWindowsRuntimeDescriptor = path.join(cacheDir, "runtime", "windows-x64", "runtime.json");
...
const configuredWindowsOutputName = process.env.GROK_BOT_WINDOWS_OUTPUT_NAME?.trim();
export const outputWindowsPortable = path.join(outputDir, configuredWindowsOutputName ? path.basename(configuredWindowsOutputName) : "Grok Bot 0.18 Reconstructed-win32-x64");
...
export const reconstructedWindowsName = "Grok Bot 0.18 Reconstructed";
export const reconstructedWindowsPackageName = "grok-bot-018-reconstructed";
export const reconstructedWindowsExecutableName = "Grok Bot 0.18 Reconstructed.exe";
...
export const windowsInstallerBytes = 125825552;
export const windowsInstallerSha256 = "464079a15ef5fa8b61ccea8fffcc78f63cfcf6df65fb0ad5e725d8b95f7e437e";
export const upstreamWindowsAsarSha256 = "38e85c0e5042c0257db7925e1e55709d6d155d90d92fe26ad654127d509766e0";
